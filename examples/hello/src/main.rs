...
pub fn app()->Elements {
	...
	apx!{
		...
		<Blk top=Pc(100.0*1.0/7.0) width=Pc(100.0) height=Pc(100.0*2.0/7.0)>
			<Bg color=0x008080/>
			<Text text="Hello World" align=Align::Center color=0xffffff size=Pc(100.0)/>
			<interaction on_click=rc_with_clone!([s],move||s.set(*s+1))/>
		</Blk>

		<Blk top=Pc(100.0*4.0/7.0) width=Pc(100.0) height=Pc(100.0*2.0/7.0)>
			<Bg color=0x008080/>
			<Text text="Hello World" align=Align::Center font=lobster color=0xffffff size=Pc(100.0)/>
		</Blk>
	}
}